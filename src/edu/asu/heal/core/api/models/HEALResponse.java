...
public class HEALResponse {
    ...
    private static final String ACTIVITY_RESOURCE_PATH = "activities";
    private static final String ACTIVITY_INSTANCE_RESOURCE_PATH = "activityinstances";
    private static final String DOMAIN_RESOURCE_PATH = "domains";
    private static final String PATIENT_RESOURCE_PATH = "patients";
    private static final String TRIAL_RESOURCE_PATH = "trials";
